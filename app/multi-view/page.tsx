    ...
    <AppShell>
      <div className="page without-voice with-bottom-tabs">
        ...
        {loading ? (
          ...
          <div className="card" style={{ padding: 20, borderRadius: 22, marginTop: 10, textAlign: 'center', background: 'rgba(110,106,248,0.04)', border: '1px solid rgba(110,106,248,0.10)' }}>
