...
function FollowUpPageContent() {
  ...
  if (!conversationId || error || !currentA1) {
    return (
      <AppShell>
  ...
  return (
    <AppShell>
      <div className="page">
        ...
        <div className="stack">
          {currentA1.ui.showReflectionCard && currentA1.assistantMessage ? <ReflectionCard title={currentRound === 3 ? '我先看到两个线索' : '我先理解一下'} text={currentA1.assistantMessage.text} /> : null}
          <QuestionCard
            badge="只问一个关键点"
